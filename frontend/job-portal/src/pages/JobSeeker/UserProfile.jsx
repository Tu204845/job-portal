            ...
            <div className="min-h-screen bg-gray-50 py-8 px-4 mt-16 lg:m-20">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        {/* Header */}
                        <div className="bg-gradient-to-r from-blue-500 to-purple-600 px-8 py-6 flex justify-between items-center">
                        ...
                        <div className="p-8 ">
                            ...
                            <div className="flex justify-end space-x-4 mt-8 pt-6 border-t">
                                ...
                                <button
                                    ...
                                    className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disable:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center space-x-2"
                                >
                                    {saving ? (
