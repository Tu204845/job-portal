...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Redirect based on user role (Đoạn mã phía dưới là phương án tương tự với logic khác một chút)
            setTimeout(() => {
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
                ...
                >
                    ...
                    <h2 className="text-2xl font-hold text-gray-900 mb-2">Welcome Back!</h2>
