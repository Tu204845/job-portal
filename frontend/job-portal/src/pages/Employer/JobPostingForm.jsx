...
const JobPostingForm = () => {
    ...
    const validateForm = (formData) => {
        ...
        if (!formData.salaryMin || !formData.salaryMax) {
            errors.salary = "Both minium and maximum salary are required";
        } else if (parseInt(formData.salaryMin) >= parseInt(formData.salaryMax)) {
            errors.salary = "Maximum salary must be greater than minium salary";
        }
                    ...
                    <div className="bg-white shadow-xl rounded-2xl p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <TextareaField
                                ...
                                helperText="Include key responsibilities, day-to-day tasks, and what make this role exciting"
                                required
                            />
