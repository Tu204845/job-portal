...
const JobCard = ({ job, onClick, onToggleSave, onApply, saved, hideApply }) => {
    ...
    return <div
        className="bg-white rounded-2xl border border-gray-200 p-6 hover:shadow-xl hover:shadow-gray-200 transition-all duration-300 group realative cursor-pointer"
        onClick={onClick}
    >
        <div className="flex items-start justify-between mb-4">
            <div className="flex items-start gap-4">
                {job?.company?.companyLogo ? (
                    ...
                    <div className="w-14 h-14 bg-gray-500 border-2 border-gray-200 rounded-2xl flex items-center justify-center">
        ...
        <div className="mb-5">
            <div className="flex items-center gap-2 text-xs">
                ...
                <span
                    className={`px-3 py-1 rounded-full font-medium ${job?.type === "Full-Time"
